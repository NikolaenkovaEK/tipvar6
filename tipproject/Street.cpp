...
unsigned int Street::GetPersonsCountWhoCanVote() const {
	// Тут можно было воспользоваться методом FilterPersonsWhoCanVote(),
	// и вернуть его количество жильцов, но создание улицы - 
	// затратная операция, поэтому подсчет сделан именно так
	unsigned int Result = 0;
